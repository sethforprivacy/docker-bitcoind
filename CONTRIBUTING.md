...
In an effort to not repeat bugs (and break less popular features), unit tests are run via [GitHub Actions](https://github.com/sethforprivacy/docker-bitcoind/actions).  The goal of the tests are to be simple and to be placed in the `test` directory where it will be automatically run.
